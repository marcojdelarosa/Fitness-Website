**Each** exercise is tracked based on specified [Muscle Groups](./muscleGroups) activated (along with their activation amount as defined by MVIC %), [Equipment](./equipment.md) required, and type (resistance, cardio, etc.).

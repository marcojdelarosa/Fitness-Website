...
We have are using SuperTest for http testing, but most of our testbed consists of ViTest examples. Please write Vitest examples for new code you create.
